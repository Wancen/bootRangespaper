...
\textbf{Results:} \bootranges provides fast functions for generation of
block bootstrapped genomic ranges representing the null hypothesis in
enrichment analysis.
As part of a modular workflow, \bootranges offers greater
...
and over-estimation of statistical significance,
while creating new
...
\bootranges is freely available at in the
