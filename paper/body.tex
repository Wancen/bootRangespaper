...
%there is a common belief in association
...
risk.
%% Therefore, there are always interest of
%% finding association among genomic, transcriptomic and epigenomic features
...
genomic features -- giving random positions to existing features, possibly
while considering an exclusion list of regions where features should not be
located. Some more sophisticated methods exist, for example
...
% ... still thinking about how to transition here...
However, random-start feature sets will not generally exhibit natural clumping
