...
and the inter-feature distances (Supplementary \cref{sec:length}).
...
single cell ATAC-seq and RNA-seq, to assess the correlation ($\rho$) of log counts for the two
modalities for all pairs of genes and peaks, across
14 cell types. Across all genes, we observed
...
and ATAC measured at local peaks had significant positive correlation.
