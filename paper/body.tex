...
bootstrap p-value:
$ \frac{1}{R} \sum_{r=1}^R 1_{\{s_r > s_{obs}\}} $ (\cref{fig:framework}B).
...
identify gene-promoter pairs that were significantly correlated across cell types (\cref{fig:suppfig}G-H).
