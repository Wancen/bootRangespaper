...
\caption{
  ...
  The GAM predicted trends for observed data (black line) and
  ...
  statistic with respect to the conditional density of GAM predicted
  values.
}
\label{fig:result}
\vspace{-0.7cm}
...
fit to the overlap rate or count over the -log10(p-value) or
gene log fold change (Supplementary Methods), both for the original
data and to each of the bootstrap datasets.
Condition densities were computed at various thresholds to reveal how
the threshold choice affected the
