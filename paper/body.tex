...
% as well as keeping compositional changes of
...
% this two don't need a "but" after them re: overly simplistic, they
% are valid attempts to deal with clustering... we just don't compare
