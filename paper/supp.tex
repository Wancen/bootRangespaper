...
This statistic can vary in many ways, including counting fraction of
overlap, restricting by the amount of overlap, and allowing for a gap
between the features, e.g. we may allow 1 kb of gap to connect local
chromatin accessibility peaks to transcription start sites (TSS).
