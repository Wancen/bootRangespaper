...
\rev{
  ...
  the test statistic distribution from shuffling, and observed that 26\%
  of the simulation distribution fell to the right of this
  threshold, for the total number of overlaps statistic.
  ...
  bootstrapping, the estimated FPR was around 6\%, close to the
  desired $\alpha = 5\%$.
